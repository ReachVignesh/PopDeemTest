...
//	Session session;
	...
	private final String SELECT = "Please select an album";
...
//			Toast.makeText(parent.getContext(), "Selected: " + item+Integer.toString(position)+"-"+albumId, Toast.LENGTH_LONG).show();
    ...
    {
        finish();
        Intent i = new Intent(this, PaymentSelectionFB.class);
        startActivity(i);
        return true;
    }
    ...
    public void onBackPressed() {
        // TODO Auto-generated method stub
        Intent i = new Intent(FbGallery.this, PaymentSelectionFB.class);
        FbGallery.this.finish();
        startActivity(i);
        super.onBackPressed();
