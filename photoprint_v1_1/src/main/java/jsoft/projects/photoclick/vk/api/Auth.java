...
public class Auth {
	...
	public static String getUrl(String api_id, String settings) {
		String url = "http://oauth.vk.com/authorize?client_id=" + api_id
				+ "&display=touch&scope=" + settings + "&redirect_uri="
	...
	public static String getSettings() {
		...
		// Цифры
		// http://vk.com/developers.php?oid=-1&p=%D0%9F%D1%80%D0%B0%D0%B2%D0%B0_%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B9
		...
		// 512 Добавление ссылки на приложение для быстрой публикации на стенах
		// пользователей.
		...
		// 1048576 stats Доступ к статистике групп и приложений пользователя,
		// администратором которых он является.
		// ads
		// nohttps
		int settings = 1 + 2 + 4 + 8 + 16 + 32 + 64 + 128 + 1024 + 2048 + 4096
				+ 8192 + 65536 + 131072 + 262144 + 524288;
		return Integer.toString(settings);
		// return
		// "friends,photos,audio,video,docs,notes,pages,wall,groups,messages,offline,notifications";
	}
