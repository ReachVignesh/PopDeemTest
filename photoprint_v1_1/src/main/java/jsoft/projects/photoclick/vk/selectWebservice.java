...
public class selectWebservice {
	...
	public static String url, result_select, user_id;
	...
	public void CALL_WEB_SERVICE(ArrayList<NameValuePair> Data) {
		url = "http://192.168.1.55/demo_web_service/select_profile.php";
		...
		try {
			...
			is.close();
			result_select = sb.toString();
			Log.d("result", result_select);
