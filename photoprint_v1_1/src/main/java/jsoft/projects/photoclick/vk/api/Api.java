...
import jsoft.projects.photoclick.vk.utils.Utils;
import jsoft.projects.photoclick.vk.utils.WrongResponseCodeException;
...
public class Api {
	...
	private JSONObject sendRequest(Params params) throws IOException,
			MalformedURLException, JSONException, KException {
	...
	private void processNetworkException(int i, IOException ex)
			throws IOException {
		ex.printStackTrace();
		if (i == MAX_TRIES)
			throw ex;
	...
	private String sendRequestInternal(String url) throws IOException,
			MalformedURLException, WrongResponseCodeException {
		...
		try {
			...
			// Ð¼Ð¾Ð¶ÐµÑ‚ Ñ�Ñ‚Ð¾Ð¸Ñ‚ Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ð½Ð° ÐºÐ¾Ð´ 200
	...
	public static String unescape(String text) {
		return text.replace("&amp;", "&").replace("&quot;", "\"")
				...
				.replace("<br/>", "\n").replace("&ndash;", "-")
				.replace("&#33;", "!").trim();
		// Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ Ñ‚ÑƒÑ‚ Ð¼Ð¾Ð³ÑƒÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð»ÑŽÐ±Ñ‹Ðµ ÐºÐ¾Ð´Ñ‹
		// Ð¿Ð¾Ñ�Ð»Ðµ &#, Ð½Ð°Ð¿Ñ€Ð¸Ð¼ÐµÑ€ Ð±Ñ‹Ð»Ð¸: 092 - backslash \
	}
	...
	public ArrayList<City> getCities(Collection<Long> cids)
	...
	public ArrayList<Country> getCountries(Collection<Long> cids)
			throws MalformedURLException, IOException, JSONException,
			KException {
		if (cids == null || cids.size() == 0)
			return null;
	...
	public ArrayList<User> getProfiles(Collection<Long> uids,
			Collection<String> domains, String fields, String name_case)
			throws MalformedURLException, IOException, JSONException,
			KException {
		...
		if (fields == null)
			params.put(
					"fields",
					"uid,first_name,last_name,nickname,domain,sex,bdate,city,country,timezone,photo,photo_medium_rec,photo_big,has_mobile,rate,contacts,education,online");
		else
	...
	public ArrayList<User> getFriends(Long user_id, String fields, Integer lid)
			throws MalformedURLException, IOException, JSONException,
			KException {
		...
		// Ñ�Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²ÐºÐ° Ð¿Ð¾ Ð¿Ð¾Ð¿ÑƒÐ»Ñ�Ñ€Ð½Ð¾Ñ�Ñ‚Ð¸ Ð½Ðµ Ð´Ð°Ñ‘Ñ‚
		// Ð·Ð°Ð¿Ñ€Ð¾Ñ�Ð¸Ñ‚ÑŒ Ð´Ñ€ÑƒÐ·ÐµÐ¹ Ð¸Ð· Ñ�Ð¿Ð¸Ñ�ÐºÐ°
		if (lid == null)
	...
	public ArrayList<Long> getOnlineFriends(Long uid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Long> getLikeUsers(String item_type, long item_id,
			long owner_id) throws MalformedURLException, IOException,
	...
	public ArrayList<Long> getMutual(Long target_uid, Long source_uid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Album> getAlbums(Long owner_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Photo> getPhotos(Long uid, Long aid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Photo> getUserPhotos(Long uid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Photo> getAllPhotos(Long owner_id, Long offset, Long count)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	// http://vkontakte.ru/developers.php?o=-1&p=photos.getUserPhotos
	public ArrayList<Photo> getUserPhotos(Long owner_id, Long offset, Long count)
			throws MalformedURLException, IOException, JSONException,
			KException {
		Params params = new Params("photos.getUserPhotos");
		params.put("owner_id", owner_id);
	...
	public CommentList getPhotoComments(Long pid, Long owner_id, int offset,
		...
		int category_count = array.length();
		for (int i = 1; i < category_count; ++i) { // get(0) is integer, it is
													// comments count
			JSONObject o = (JSONObject) array.get(i);
	...
	public CommentList getNoteComments(Long nid, Long owner_id, int offset,
			int count) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public CommentList getVideoComments(long video_id, Long owner_id,
			int offset, int count) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Comment> getAllPhotoComments(Long owner_id, Long album_id,
			int offset, int count) throws MalformedURLException, IOException,
			JSONException, KException {
		...
		JSONObject root = sendRequest(params);
		// Ð·Ð´ÐµÑ�ÑŒ ÐµÑ‰Ñ‘ Ð¿Ñ€Ð¸Ñ…Ð¾Ð´Ð¸Ñ‚ pid - photo_id
		// Ð²Ñ‹Ð½ÐµÑ�Ñ‚Ð¸ Ð¿Ð°Ñ€Ñ�Ñ�Ñ‰Ð¸Ð¹ ÐºÐ¾Ð´ Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð½Ðµ Ð±Ñ‹Ð»Ð¾
	...
	public long createPhotoComment(Long pid, Long owner_id, String message,
			Long reply_to_cid, String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public long createNoteComment(Long nid, Long owner_id, String message,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public long createVideoComment(Long video_id, Long owner_id,
			String message, String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	private void addCaptchaParams(String captcha_key, String captcha_sid,
			Params params) {
	...
	public ArrayList<Message> getMessages(long time_offset, boolean is_out,
			int count) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Message> getMessagesHistory(long uid, long chat_id,
			long me, Long offset, int count) throws MalformedURLException,
		...
		JSONObject root = sendRequest(params);
		JSONArray array = root.optJSONArray("response");
		ArrayList<Message> messages = parseMessages(array, chat_id <= 0, uid,
				chat_id > 0, me);
		return messages;
	}

	// http://vkontakte.ru/developers.php?o=-1&p=messages.getDialogs
	public ArrayList<Message> getMessagesDialogs(long offset, int count)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	private ArrayList<Message> parseMessages(JSONArray array,
			boolean from_history, long history_uid, boolean from_chat, long me)
		...
		if (array != null) {
			...
			for (int i = 1; i < category_count; ++i) {
				JSONObject o = (JSONObject) array.get(i);
				Message m = Message.parse(o, from_history, history_uid,
						from_chat, me);
				messages.add(m);
			}
		}
	...
	public String sendMessage(Long uid, long chat_id, String message,
			String title, String type, Collection<String> attachments,
			ArrayList<Long> forward_messages, String lat, String lon,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String markAsNewOrAsRead(ArrayList<Long> mids, boolean as_read)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String deleteMessage(Long mid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public VkStatus getStatus(Long uid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String setStatus(String status_text, String audio)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Newsfeed getNews(long start_time, long count, long end_time)
			throws MalformedURLException, IOException, JSONException,
			KException {
		Params params = new Params("newsfeed.get");
		params.put("filters", "post,photo,photo_tag,friend,note");
		params.put("start_time", (start_time == -1) ? getDefaultStartTime()
				: start_time);
		if (end_time != -1)
	...
	// Ð�Ð¾Ð²Ð¾Ñ�Ñ‚Ð¸-ÐšÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸Ð¸. ÐžÐ¿Ð¸Ñ�Ð°Ð½Ð¸Ñ� Ð½ÐµÑ‚.
	public Newsfeed getNewsComments() throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<Audio> getAudio(Long uid, Long gid, Long album_id,
			Collection<Long> aids) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Audio> getAudioById(String audios)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String getLyrics(Long id) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Video> getVideo(String videos, Long owner_id,
			Long album_id, String width, Long count, Long offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Video> getUserVideo(Long user_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Album createAlbum(String title, String privacy,
			String comment_privacy, String description)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String editAlbum(long aid, String title, String privacy,
			String comment_privacy, String description)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Note> getNotes(Long uid, Collection<Long> nids,
			String sort, Long count, Long offset) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String deleteNote(Long nid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String photosGetUploadServer(long album_id, Long group_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String photosGetWallUploadServer(Long user_id, Long group_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String getAudioUploadServer() throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String photosGetMessagesUploadServer() throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String photosGetProfileUploadServer() throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<Photo> photosSave(String server, String photos_list,
			Long aid, Long group_id, String hash, String caption)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Photo> saveWallPhoto(String server, String photo,
			String hash, Long user_id, Long group_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Audio saveAudio(String server, String audio, String hash,
			String artist, String title) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String[] saveProfilePhoto(String server, String photo, String hash)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	/*
	 * public long createGraffitiComment(String gid, String owner_id, String
	 * message, String captcha_key, String captcha_sid) throws
	 * MalformedURLException, IOException, JSONException, KException{ Params
	 * params = new Params("graffiti.createComment"); params.put("gid",gid);
	 * params.put("owner_id",owner_id); addCaptchaParams(captcha_key,
	 * captcha_sid, params); params.put("message",message); JSONObject root =
	 * sendRequest(params); long message_id = root.optLong("response"); return
	 * message_id; }
	 */

	// http://vkontakte.ru/developers.php?o=-1&p=wall.addComment
	public long createWallComment(Long owner_id, Long post_id, String text,
			Long reply_to_cid, String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public long createWallPost(long owner_id, String text,
			Collection<String> attachments, String export,
			boolean only_friends, boolean from_group, boolean signed,
			String lat, String lon, String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public CommentList getWallComments(Long owner_id, Long post_id, int offset,
			int count) throws MalformedURLException, IOException,
			JSONException, KException {
		...
		params.put("owner_id", owner_id);
		/*
		 * if (sort != null) params.put("sort", sort); //asc -
		 * Ñ…Ñ€Ð¾Ð½Ð¾Ð»Ð¾Ð³Ð¸Ñ‡ÐµÑ�ÐºÐ¸Ð¹ //desc -
		 * Ð°Ð½Ñ‚Ð¸Ñ…Ñ€Ð¾Ð½Ð¾Ð»Ð¾Ð³Ð¸Ñ‡ÐµÑ�ÐºÐ¸Ð¹
		 */
		if (offset > 0)
			params.put("offset", offset);
		if (count > 0)
		...
		int category_count = array.length();
		for (int i = 1; i < category_count; ++i)
			// get(0) is integer, it is comments count
			commnets.comments.add(Comment.parse((JSONObject) array.get(i)));
		return commnets;
	}

	// http://vkontakte.ru/developers.php?o=-1&p=audio.search
	public ArrayList<Audio> searchAudio(String q, String sort, String lyrics,
			Long count, Long offset) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public String deleteAudio(Long aid, Long oid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String addAudio(Long aid, Long oid, Long gid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Long wallAddLike(Long owner_id, Long post_id, boolean need_publish,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Long wallDeleteLike(Long owner_id, Long post_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Long addLike(Long owner_id, Long item_id, String type,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Long deleteLike(Long owner_id, Long item_id, String type)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Long addLike(Long owner_id, String type, Long item_id,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
		Params params = new Params("likes.add");
	...
	public Long deleteLike(Long owner_id, String type, Long item_id,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
		Params params = new Params("likes.delete");
	...
	public ArrayList<Photo> getPhotosById(String photos)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Group> getUserGroups(Long user_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean removeWallPost(Long post_id, long wall_owner_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean deleteWallComment(Long wall_owner_id, long comment_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean deleteNoteComment(Long note_owner_id, long comment_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean deleteVideoComment(Long video_owner_id, long comment_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean deletePhotoComment(long photo_id, Long photo_owner_id,
			long comment_id) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Video> searchVideo(String q, String sort, String hd,
			Long count, Long offset) throws MalformedURLException, IOException,
			JSONException, KException {
		...
		// TODO Ð­Ñ‚Ð¾ Ð²Ñ€Ð¾Ð´Ðµ Ð»Ð¸ÑˆÐ½ÐµÐµ. Ð’ Ñ€ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ð°Ñ…
		// Ð¿Ð¾Ð¸Ñ�ÐºÐ° Ð½Ðµ Ñ…Ð²Ð°Ñ‚Ð°ÐµÑ‚ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ link, Ð½Ð¾ Ð²ÐµÐ´ÑŒ
		// Ð¾Ð½ Ñ�Ð¾Ñ�Ñ‚Ð°Ð²Ð»Ñ�ÐµÑ‚Ñ�Ñ� Ð¸Ð· owner_id+video_id
		String video_ids = "";
		for (Video v : videoss) {
			video_ids = video_ids + String.valueOf(v.owner_id) + "_"
					+ String.valueOf(v.vid) + ",";
		}
		return getVideo(video_ids, null, null, null, null, null);
	}

	// no documentation
	public ArrayList<User> searchUser(String q, String fields, Long count,
			Long offset) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public String deleteVideo(Long vid, Long oid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String addVideo(Long vid, Long oid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public long createNote(String title, String text)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Object[] getLongPollServer() throws MalformedURLException,
			IOException, JSONException, KException {
	...
	// Ð½Ðµ Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½
	public void setOnline() throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public long addFriend(Long uid, String text, String captcha_key,
			String captcha_sid) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public long deleteFriend(Long uid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<Object[]> getRequestsFriends()
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String followUser(Long uid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public String unfollowUser(Long uid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<Long> getSubscriptions(Long uid, int offset, int count)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Long> getFollowers(Long uid, int offset, int count)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public int deleteMessageThread(Long uid, Long chatId)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public void execute(String code) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public boolean deletePhoto(Long owner_id, Long photo_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public VkPoll getPoll(long poll_id, long owner_id) throws JSONException,
			MalformedURLException, IOException, KException {
	...
	public int addPollVote(long poll_id, long answer_id, long owner_id)
	...
	public int deletePollVote(long poll_id, long answer_id, long owner_id)
			throws JSONException, MalformedURLException, IOException,
			KException {
	...
	public ArrayList<FriendsList> friendsLists() throws JSONException,
			MalformedURLException, IOException, KException {
	...
	public String saveVideo(String name, String description, Long gid,
			int privacy_view, int privacy_comment)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String deleteAlbum(Long aid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<PhotoTag> getPhotoTagsById(Long pid, Long owner_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	private ArrayList<PhotoTag> parsePhotoTags(JSONArray array, Long pid,
			Long owner_id) throws JSONException {
	...
	public String putPhotoTag(PhotoTag ptag, String captcha_key,
			String captcha_sid) throws MalformedURLException, IOException,
			JSONException, KException {
		if (ptag == null)
			return null;
	...
	public ArrayList<GroupTopic> getGroupTopics(long gid, int extended,
			int count, int offset) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public CommentList getGroupTopicComments(long gid, long tid,
			int photo_sizes, int extended, int count, int offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
		...
		if (response != null) {
			...
			for (int i = 1; i < category_count; ++i) { // get(0) is integer, it
														// is comments count
	...
	public long createGroupTopicComment(long gid, long tid, String text,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean deleteGroupTopicComment(long gid, long tid, long cid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public long createGroupTopic(long gid, String title, String text,
			String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Boolean deleteGroupTopic(long gid, long tid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Group> getGroups(Collection<Long> uids, String domain,
			String fields) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	// no documentation
	public String joinGroup(long gid, String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	// no documentation
	public String leaveGroup(long gid) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	// no documentation
	public ArrayList<Group> searchGroup(String q, Long count, Long offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String registerDevice(String token, String device_model,
			String system_version, Integer no_text)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String unregisterDevice(String token) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public Notifications getNotifications(String filters, Long start_time,
			Long end_time, Integer offset, Integer count)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public String resetUnreadNotifications() throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<Message> getMessagesById(ArrayList<Long> message_ids)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Counters getCounters() throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<User> getFaveUsers(String fields, Integer count,
			Integer offset) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Photo> getFavePhotos(Integer count, Integer offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Video> getFaveVideos(Integer count, Integer offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<WallMessage> getFavePosts(Integer count, Integer offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Link> getFaveLinks(Integer count, Integer offset)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Long chatCreate(ArrayList<Long> uids, String title)
			throws MalformedURLException, IOException, JSONException,
			KException {
		if (uids != null && uids.size() > 0)
			return null;
	...
	public Integer chatEdit(long chat_id, String title)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<User> getChatUsers(long chat_id, String fields)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Integer addUserToChat(long chat_id, long uid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Integer removeUserFromChat(long chat_id, long uid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<User> getSuggestions(String filter, String fields)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Integer importContacts(Collection<String> contacts)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<User> getFriendsByPhones(ArrayList<String> phones,
			String fields) throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<Message> searchMessages(String q, int offset, int count)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<SearchDialogItem> searchDialogs(String q, String fields)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public LastActivity getLastActivity(long user_id)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<Long> getGroupsMembers(long gid, Integer count,
			Integer offset, String sort) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	// http://vk.com/developers.php?oid=-1&p=groups.getMembers
	public Long getGroupsMembersCount(long gid) throws MalformedURLException,
			IOException, JSONException, KException {
		Params params = new Params("groups.getMembers");
		params.put("gid", gid);
		params.put("count", 10);
	...
	public ArrayList<User> getGroupsMembersWithExecute(long gid, Integer count,
			Integer offset, String sort, String fields)
			throws MalformedURLException, IOException, JSONException,
			KException {
		// String code =
		// "return API.getProfiles({\"uids\":API.groups.getMembers({\"gid\":" +
		// String.valueOf(gid) + ",\"count\":" + String.valueOf(count) +
		// ",\"offset\":" + String.valueOf(offset) +
		// ",\"sort\":\"id_asc\"}),\"fields\":\"" + fields + "\"});";
		String code = "var members=API.groups.getMembers({\"gid\":"
				+ gid
				+ "}); var u=members[1]; return API.getProfiles({\"uids\":u,\"fields\":\""
				+ fields + "\"});";
		Params params = new Params("execute");
		params.put("code", code);
		JSONObject root = sendRequest(params);
	...
	public long getServerTime() throws MalformedURLException, IOException,
			JSONException, KException {
	...
	public ArrayList<AudioAlbum> getAudioAlbums(Long uid, Long gid,
			Integer offset, Integer count) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public ArrayList<Audio> getAudioRecommendations()
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public ArrayList<AudioAlbum> getVideoAlbums(Long uid, Long gid,
			Integer offset, Integer count) throws MalformedURLException,
			IOException, JSONException, KException {
	...
	public Integer setMessageActivity(long uid, long chat_id, boolean typing)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public int editWallPost(long owner_id, long post_id, String text,
			Collection<String> attachments, String lat, String lon,
			long place_id, String captcha_key, String captcha_sid)
			throws MalformedURLException, IOException, JSONException,
			KException {
	...
	public Integer photoEdit(Long owner_id, long pid, String caption)
			throws MalformedURLException, IOException, JSONException,
			KException {
